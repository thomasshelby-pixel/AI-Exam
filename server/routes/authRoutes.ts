...
// Google Sign-In Endpoints - Discontinued in favor of secure Email + Password Authentication
router.post('/google', (req: Request, res: Response) => {
  return res.status(410).json({
    error: 'Google Sign-In has been discontinued on this portal. Please sign in with your email and password. If you previously used Google, please use "Forgot Password" to set a password for your account.',
    code: 'GOOGLE_SIGNIN_DISCONTINUED',
  });
});

// Google Onboarding / Complete Profile Endpoint - Discontinued
router.post('/google/complete-profile', (req: Request, res: Response) => {
  return res.status(410).json({
    error: 'Google Sign-In onboarding has been discontinued. Please register or sign in directly with email and password.',
    code: 'GOOGLE_SIGNIN_DISCONTINUED',
  });
});
